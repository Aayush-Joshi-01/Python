...
VEG_MENU = {
    'Main Course' : ['Paneer Tikka Masala', 'Paneer Butter Masala', 'Mix Veg', 'Palak Paneer', 'Yellow Dal Tadka', 'Dal Makhani'],
    'Starters' : ['Veg Lollipop', 'Crispy Corn', 'Veg Kothe', 'Paneer Tikka', '']
}
NON_VEG_MENU = {
    'Main Course' : ['Chicken Tikka Masala', 'Chicken Butter Masala', 'Mix Veg', 'Palak Chicken', 'Yellow Dal Tadka', 'Dal Makhani'],
