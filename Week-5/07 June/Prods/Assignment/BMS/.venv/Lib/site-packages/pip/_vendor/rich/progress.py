...
class Progress(JupyterMixin):
    ...
    Args:
        ...
        speed_estimate_period: (float, optional): Period (in seconds) used to Calculator the speed estimate. Defaults to 30.
        transient: (bool, optional): Clear the progress on exit. Defaults to False.
    ...
    def add_task(
        ...
        Args:
            ...
            start (bool, optional): Start the task immediately (to Calculator elapsed time). If set to False,
