...
class DependencyGraph(object):
    ...
    def add_distribution(self, distribution):
        ...
        :type distribution: :class:`distutils2.db.InstalledDistribution`
                            or :class:`distutils2.db.EggInfoDistribution`
        """
    ...
    def add_edge(self, x, y, label=None):
        ...
        *label*.
        ...
        :type x: :class:`distutils2.db.InstalledDistribution` or
                 :class:`distutils2.db.EggInfoDistribution`
        :type y: :class:`distutils2.db.InstalledDistribution` or
                 :class:`distutils2.db.EggInfoDistribution`
...
def make_graph(dists, scheme='default'):
    ...
    :type dists: list of :class:`distutils2.db.InstalledDistribution` and
                 :class:`distutils2.db.EggInfoDistribution` instances
