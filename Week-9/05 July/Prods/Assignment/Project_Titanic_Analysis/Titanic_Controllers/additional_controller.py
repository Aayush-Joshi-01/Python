    ...
    def survival_rate_by_category(data: np.ndarray, category_col: str) -> List[Tuple[str, float]]:
        ...
        for category in categories:
            ...
            if total_passengers == 0:
                continue
            survived_passengers = np.sum(
                (data[category_col] == category) & (data['survived'] == 1))  # Survived passengers in this category
...
if __name__ == '__main__':
    ...
    controller = Additional_Controller()  # Create an instance of Additonal_Controller
