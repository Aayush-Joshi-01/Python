...
def find_most_frequent_word(text: str, stopwords: set = None) -> str:
    if stopwords is None:
        stopwords = {"the", "is", "and", "are", "am", "a", "an", "in", "it", "you", "i", "to", "of", "for", "on", "that", "with", "was", "he", "she", "as", "his", "her", "its", "had", "have", "has", "but", "not", "be", "were", "by", "at", "so", "we", "they", "my", "your", "from", "who", "which", "there", "or", "us", "this", "him", "me", "what", "why", "how", "when", "where", "up", "down", "out", "off", "over", "under", "again", "then", "once", "here", "there", "all", "any", "both", "each", "few", "more", "most", "other", "some", "such", "no", "nor", "only", "own", "same", "so", "than", "too", "very", "can", "will", "just", "don", "should", "now"}
