def find_out_of_stock_products(warehouse_product_stock):
    ...
    for warehouse in warehouse_product_stock:
        out_of_stock_products.update(product for product in warehouse_product_stock[warehouse] if product not in warehouse_product_stock[warehouse] or warehouse_product_stock[warehouse][product] <= 0)
