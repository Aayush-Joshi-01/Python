...
if __name__ == '__main__':
    ...
    print(f"Book with the highest rating: {library_summary['highest_rated_book']['title']} by {library_summary['highest_rated_book']['author']} with rating {library_summary['highest_rated_book']['rating']:.2f}")
