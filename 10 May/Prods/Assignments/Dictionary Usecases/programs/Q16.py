...
if __name__ == '__main__':
    ...
    print(f"Investment with the highest return: {investment_overview['highest_return_investment']['name']} ({investment_overview['highest_return_investment']['type']}) with return {investment_overview['highest_return_investment']['return']:.2%}")
